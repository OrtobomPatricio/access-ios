...
-- 2. ADD organization_id TO USERS_PROFILE
...
-- 9. FUNCTION: Create organization for new user
...
-- 10. FUNCTION: Ensure user has organization (called from ensure_profile edge function)
...
-- 11. UPDATE RPC FUNCTIONS TO FILTER BY ORGANIZATION
